...
class CalculationControllerTest {
    ...
    void calculate_success() throws Exception {
        CalculationResponse response = CalculationResponse.builder()
                ...
                .refundAmount(49000)
                .deductibleAmount(51000)
                .basis("계산 근거")
                .deductibleBasis("30,000원 공제 후 잔여 진료비의 70% 보장(잔여 자기부담 30%)")
                .fixedDeductibleAmount(30000)
                .fixedDeductibleRate(30)
                .disclaimer("주의사항")
        ...
        mockMvc.perform(post("/api/calculations")
                ...
                .andExpect(jsonPath("$.data.refundAmount").value(49000))
                .andExpect(jsonPath("$.data.deductibleAmount").value(51000))
                .andExpect(jsonPath("$.data.basis").value("계산 근거"))
                .andExpect(jsonPath("$.data.deductibleBasis").value("30,000원 공제 후 잔여 진료비의 70% 보장(잔여 자기부담 30%)"))
                .andExpect(jsonPath("$.data.fixedDeductibleAmount").value(30000))
                .andExpect(jsonPath("$.data.fixedDeductibleRate").value(30))
                .andExpect(jsonPath("$.data.coveredBaseAmount").doesNotExist())
                .andExpect(jsonPath("$.data.coverageRate").doesNotExist())
                .andExpect(jsonPath("$.data.refundAmountBeforeLimit").doesNotExist())
                .andExpect(jsonPath("$.data.limitAmount").doesNotExist())
                .andExpect(jsonPath("$.data.limitApplied").doesNotExist())
                ...
                .andExpect(jsonPath("$.data.deductibleRate").value(51))
                .andExpect(jsonPath("$.data.refundRate").value(49))
